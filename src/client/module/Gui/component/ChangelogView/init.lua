...
local ChangelogView = Roact.Component:extend("VersionLabel")

function ChangelogView:render()
    if self.props.view == "changelog" then
...
ChangelogView = RoactRodux.connect(mapStateToProps,mapDispatchToProps)(ChangelogView)
